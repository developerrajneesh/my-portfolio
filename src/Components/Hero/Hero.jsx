  ...
  return (
    <>
      <div className="row m-0">
        <div className="col-12 col-md-6 d-flex justify-content-center align-items-center HeroImg">
          <div>
            <h4>Hello !</h4>
            ...
            <div className="d-flex position-relative hire-btn-group gap-3 mt-5">
        ...
        <div className="col-12 col-md-6 d-flex d-none d-md-flex justify-content-center align-items-center ">
          <img src={HeroImg} alt="HeroImg img-fluid" />
        </div>
      </div>
    </>
  );
